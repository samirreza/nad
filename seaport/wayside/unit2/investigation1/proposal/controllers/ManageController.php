...
namespace nad\seaport\wayside\unit2\investigation1\proposal\controllers;

use yii\helpers\ArrayHelper;
use yii\filters\AccessControl;
use nad\seaport\wayside\unit2\investigation1\proposal\models\Proposal;
use nad\seaport\wayside\unit2\investigation1\proposal\models\ProposalArchived;
use nad\seaport\wayside\unit2\investigation1\proposal\models\ProposalSearch;
use nad\seaport\wayside\unit2\investigation1\proposal\models\ProposalArchivedSearch;
