...
namespace nad\seaport\wayside\unit1\investigation3\proposal\controllers;

use yii\helpers\ArrayHelper;
use yii\filters\AccessControl;
use nad\seaport\wayside\unit1\investigation3\proposal\models\Proposal;
use nad\seaport\wayside\unit1\investigation3\proposal\models\ProposalArchived;
use nad\seaport\wayside\unit1\investigation3\proposal\models\ProposalSearch;
use nad\seaport\wayside\unit1\investigation3\proposal\models\ProposalArchivedSearch;
