        ...
        <?= DetailView::widget([
            ...
            'attributes' => [
                ...
                [
                    ...
                    'value' => $source->getExpertEmailsAsString()
                ],
                [
                    'attribute' => 'status',
                    'label' => 'وضعیت منشا',
        ...
        <?= DetailView::widget([
            ...
            'attributes' => [
                ...
                [
                    ...
                    'format' => 'date',
                    'value' => $proposal->source->getDeliveryToExpertsTime()
                ],
                [
                    'attribute' => 'createdAt',
                    'format' => 'date',
                ...
                [
                    ...
                    'value' => $proposal->getPartnerEmailsAsString()
                ],
                [
                    'attribute' => 'tags',
