...
namespace nad\process\ird\filter\investigationDesign;
...
class Module extends \yii\base\Module
{
    ...
    {
        $this->modules = [
            'source' => 'nad\process\ird\filter\investigationDesign\source\Module',
            'proposal' => 'nad\process\ird\filter\investigationDesign\proposal\Module',
            'report' => 'nad\process\ird\filter\investigationDesign\report\Module',
            'reference' => 'nad\process\ird\filter\investigationDesign\reference\Module',
            'method' => 'nad\process\ird\filter\investigationDesign\method\Module',
            'instruction' => 'nad\process\ird\filter\investigationDesign\instruction\Module',
        ];
