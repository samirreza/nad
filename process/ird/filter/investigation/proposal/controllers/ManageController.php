...
namespace nad\process\ird\filter\investigation\proposal\controllers;

use yii\helpers\ArrayHelper;
use yii\filters\AccessControl;
use nad\process\ird\filter\investigation\proposal\models\Proposal;
use nad\process\ird\filter\investigation\proposal\models\ProposalArchived;
use nad\process\ird\filter\investigation\proposal\models\ProposalSearch;
use nad\process\ird\filter\investigation\proposal\models\ProposalArchivedSearch;
