...
class Module extends \yii\base\Module
{
    ...
    public function init()
    {
        $this->modules = [
            ...
            'instruction' => 'nad\process\ird\cartridge\investigation\instruction\Module',
            'subject' => 'nad\process\ird\cartridge\investigation\subject\Module',
        ];
                ...
                'items' => [
                    [
                        ...
                        'items' => [
                            [
                                'label' => 'افزودن منشا',
                                'url' => ['/process/ird/cartridge/investigation/source/manage/create']
                            ],
                            [
                            ...
                            [
                                ...
                                'url' => ['/process/ird/cartridge/investigation/source/category/index']
                            ],
                        ]
                    ],
                    [
                    ...
                    [
                        ...
                        'items' => [
                            [
                                ...
                                'url' => ['/process/ird/cartridge/investigation/proposal/manage/create']
                            ],
                            [
                            ...
                            [
                                ...
                                'url' => ['/process/ird/cartridge/investigation/proposal/category/index']
                            ],
                        ]
                    ],
                    [
                ...
                'items' => [
                    [
                        ...
                        'items' => [
                            [
                                'label' => 'افزودن گزارش',
                                'url' => ['/process/ird/cartridge/investigation/report/manage/create']
                            ],
                            [
                            ...
                            [
                                ...
                                'url' => ['/process/ird/cartridge/investigation/report/category/index']
                            ],
                            [
                                'label' => 'گراف گزارشات',
                                'url' => ['/process/ird/cartridge/investigation/report/manage/generate-graph']
                            ]
                        ]
                    ],
                    [
                ...
                'items' => [
                    [
                        ...
                        'items' => [
                            [
                                'label' => 'افزودن روش',
                                'url' => ['/process/ird/cartridge/investigation/method/manage/create']
                            ],
                            [
                            ...
                            [
                                ...
                                'url' => ['/process/ird/cartridge/investigation/method/category/index']
                            ],
                        ]
                    ],
                    [
                    ...
                    [
                        ...
                        'items' => [
                            [
                                ...
                                'url' => ['/process/ird/cartridge/investigation/instruction/manage/create']
                            ],
                            [
                            ...
                            [
                                ...
                                'url' => ['/process/ird/cartridge/investigation/instruction/category/index']
                            ],
                        ]
                    ],
                    [
                ...
                'items' => [
                    [
                        ...
                        'items' => [
                            [
                                'label' => 'افزودن موضوع',
                                'url' => ['/process/ird/cartridge/investigation/subject/manage/create']
                            ],
                            [
