    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <?= InfoBox::widget([
                ...
                'showCount' => false,
                'title' => 'دستورالعمل',
                'titleUrl' => Url::to(['/cartridge/investigationMonitor/instruction/manage/index'])
            ]) ?>
        </div>
    </div>
    <?php Panel::end() ?>
...
<div class="row" style="text-align: center">
    ...
    <div class="col-md-5">
        <?= InfoBox::widget([
            ...
            'showCount' => false,
            'title' => 'پروپوزال ها',
            'titleUrl' => Url::to(['/cartridge/investigationMonitor/proposal/manage/archived-index'])
        ]) ?>
    </div>
    <div class="col-md-5">
        <?= InfoBox::widget([
            ...
            'titleUrl' => Url::to(['/cartridge/investigationMonitor/proposal/manage/index-history'])
        ]) ?>
    </div>
</div>
<br><br>
<div class="row" style="text-align: center">
    ...
    <div class="col-md-5">
        <?= InfoBox::widget([
            ...
            'showCount' => false,
            'title' => 'گزارش ها',
            'titleUrl' => Url::to(['/cartridge/investigationMonitor/report/manage/archived-index'])
        ]) ?>
    </div>
    <div class="col-md-5">
        <?= InfoBox::widget([
            ...
            'titleUrl' => Url::to(['/cartridge/investigationMonitor/report/manage/index-history'])
        ]) ?>
    </div>
</div>
<br><br>
<div class="row" style="text-align: center">
    ...
    <div class="col-md-5">
        <?= InfoBox::widget([
            ...
            'showCount' => false,
            'title' => 'روش ها',
            'titleUrl' => Url::to(['/cartridge/investigationMonitor/method/manage/archived-index'])
        ]) ?>
    </div>
    <div class="col-md-5">
        <?= InfoBox::widget([
            ...
            'titleUrl' => Url::to(['/cartridge/investigationMonitor/method/manage/index-history'])
        ]) ?>
    </div>
</div>
<br><br>
