...
namespace nad\process\ird\microbial\investigationMonitor\reference\controllers;

use yii\helpers\ArrayHelper;
use yii\filters\AccessControl;
use nad\process\ird\microbial\investigationMonitor\reference\models\Reference;
use nad\process\ird\microbial\investigationMonitor\reference\models\ReferenceSearch;
