    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <?= InfoBox::widget([
                ...
                'showCount' => false,
                'title' => 'منشا',
                'titleUrl' => Url::to(['/introduction/investigation/source/manage/index'])
            ]) ?>
        </div>
        <div class="col-md-3">
            <?= InfoBox::widget([
                ...
                'showCount' => false,
                'title' => 'پروپوزال',
                'titleUrl' => Url::to(['/introduction/investigation/proposal/manage/index'])
            ]) ?>
        </div>
        <div class="col-md-3"></div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <?= InfoBox::widget([
                ...
                'showCount' => false,
                'title' => 'سایرگزارشها',
                'titleUrl' => Url::to(['/introduction/investigation/subject/manage/index'])
            ]) ?>
        </div>
    </div>
    <?php Panel::end() ?>
