...
class Module extends \yii\base\Module
{
    ...
    public function init()
    {
        $this->modules = [
            ...
            'subject' => 'nad\process\ird\introduction\investigation\subject\Module',
        ];
                ...
                'items' => [
                    [
                        ...
                        'items' => [
                            [
                                'label' => 'افزودن منشا',
                                'url' => ['/process/ird/introduction/investigation/source/manage/create']
                            ],
                            [
                            ...
                            [
                                ...
                                'url' => ['/process/ird/introduction/investigation/source/category/index']
                            ],
                        ]
                    ],
                    [
                    ...
                    [
                        ...
                        'items' => [
                            [
                                ...
                                'url' => ['/process/ird/introduction/investigation/proposal/manage/create']
                            ],
                            [
                            ...
                            [
                                ...
                                'url' => ['/process/ird/introduction/investigation/proposal/category/index']
                            ],
                        ]
                    ],
                    [
                ...
                'items' => [
                    [
                        ...
                        'items' => [
                            [
                                'label' => 'افزودن گزارش',
                                'url' => ['/process/ird/introduction/investigation/report/manage/create']
                            ],
                            [
                            ...
                            [
                                ...
                                'url' => ['/process/ird/introduction/investigation/report/category/index']
                            ],
                            [
                                'label' => 'گراف گزارشات',
                                'url' => ['/process/ird/introduction/investigation/report/manage/generate-graph']
                            ]
                        ]
                    ],
                    [
                ...
                'items' => [
                    [
                        ...
                        'items' => [
                            [
                                'label' => 'افزودن روش',
                                'url' => ['/process/ird/introduction/investigation/method/manage/create']
                            ],
                            [
                            ...
                            [
                                ...
                                'url' => ['/process/ird/introduction/investigation/method/category/index']
                            ],
                        ]
                    ],
                    [
                    ...
                    [
                        ...
                        'items' => [
                            [
                                ...
                                'url' => ['/process/ird/introduction/investigation/instruction/manage/create']
                            ],
                            [
                            ...
                            [
                                ...
                                'url' => ['/process/ird/introduction/investigation/instruction/category/index']
                            ],
                        ]
                    ],
                    [
                ...
                'items' => [
                    [
                        ...
                        'items' => [
                            [
                                'label' => 'افزودن موضوع',
                                'url' => ['/process/ird/introduction/investigation/subject/manage/create']
                            ],
                            [
