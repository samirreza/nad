...
namespace nad\process\laboratory\unit3\investigation1\proposal\controllers;

use yii\helpers\ArrayHelper;
use yii\filters\AccessControl;
use nad\process\laboratory\unit3\investigation1\proposal\models\Proposal;
use nad\process\laboratory\unit3\investigation1\proposal\models\ProposalArchived;
use nad\process\laboratory\unit3\investigation1\proposal\models\ProposalSearch;
use nad\process\laboratory\unit3\investigation1\proposal\models\ProposalArchivedSearch;
