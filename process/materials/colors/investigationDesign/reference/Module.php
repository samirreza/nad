...
namespace nad\process\materials\colors\investigationDesign\reference;

use nad\process\materials\colors\investigationDesign\Module as BaseModule;
        ...
        $this->horizontalMenuItems = [
            ...
            [
                ...
                'items' => [
                    ...
                    [
                        'label' => 'افزودن منبع',
                        'url' => ['/process/materials/colors/investigationDesign/reference/manage/index#class_ajaxcreate']
                    ]
                ]
            ]
        ];
