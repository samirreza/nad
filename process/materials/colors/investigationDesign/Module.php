...
namespace nad\process\materials\colors\investigationDesign;
...
class Module extends \yii\base\Module
{
    ...
    {
        $this->modules = [
            'source' => 'nad\process\materials\colors\investigationDesign\source\Module',
            'proposal' => 'nad\process\materials\colors\investigationDesign\proposal\Module',
            'report' => 'nad\process\materials\colors\investigationDesign\report\Module',
        ...
        $this->horizontalMenuItems = [
                ...
                'items' => [
                    [
                        ...
                        'items' => [
                            [
                                'label' => 'افزودن منشا',
                                'url' => ['/colors/investigationDesign/source/manage/create']
                            ],
                            [
                            ...
                            [
                                ...
                                'url' => ['/colors/investigationDesign/source/category/index']
                            ],
                        ]
                    ],
                    [
                    ...
                    [
                        ...
                        'items' => [
                            [
                                ...
                                'url' => ['/colors/investigationDesign/proposal/manage/create']
                            ],
                            [
                            ...
                            [
                                ...
                                'url' => ['/colors/investigationDesign/proposal/category/index']
                            ],
                        ]
                    ],
                    [
                ...
                'items' => [
                    [
                        ...
                        'items' => [
                            [
                                'label' => 'افزودن گزارش',
                                'url' => ['/colors/investigationDesign/report/manage/create']
                            ],
                            [
                            ...
                            [
                                ...
                                'url' => ['/colors/investigationDesign/report/category/index']
                            ],
                            [
                                'label' => 'گراف گزارشات',
                                'url' => ['/colors/investigationDesign/report/manage/generate-graph']
                            ]
                        ]
                    ],
                    [
            ...
            //                 [
            //                     'label' => 'افزودن روش',
            //                     'url' => ['/colors/investigationDesign/method/manage/create']
            //                 ],
            //                 [
            ...
            //                     'url' => ['/colors/investigationDesign/method/category/index']
            //                 ],
            //             ]
            //         ],
            //         [
            ...
            //                     'url' => ['/colors/investigationDesign/instruction/manage/create']
            //                 ],
            //                 [
            ...
            //                     'url' => ['/colors/investigationDesign/instruction/category/index']
            //                 ],
            //             ]
            //         ],
            //         [
            ...
            [
                ...
                'items' => [
                    ...
                    [
                        'label' => 'افزودن منبع',
                        'url' => ['/colors/investigationDesign/reference/manage/index#class_ajaxcreate']
                    ]
                ]
            ]
        ];
