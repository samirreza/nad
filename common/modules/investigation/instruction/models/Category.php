...
class Category extends ActiveRecord implements Codable
{
    ...
    {
        return $this->hasMany(Instruction::class, ['categoryId' => 'id']);
    }
    ...
    public function getFamilyTreeArrayForWidget()
    {
        ...
        if ($this->children(1)->count() != 0) {
            ...
            foreach ($this->instructions as $instruction) {
                $children[] = [
                    'id' => $instruction->id,
                    'name' => $instruction->htmlCodedTitle,
                    'code' => $instruction->uniqueCode,
    ...
    {
        return 'nad_investigation_instruction_category';
    }
