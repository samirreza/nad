...
use nad\common\modules\investigation\otherreport\models\OtherreportReason;
...
<div class="otherreport-index">
    <?php Panel::begin(['title' => $this->title]) ?>
        <?php Pjax::begin(['id' => 'otherreport-index-gridviewpjax']) ?>
            <?= GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'filter' => Otherreport::getStatusLables(),
                        'options' => [
                            'width' => '150px'
                        ]
                    ],
