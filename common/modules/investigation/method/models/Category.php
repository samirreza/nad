...
class Category extends ActiveRecord implements Codable
{
    ...
    {
        return $this->hasMany(Method::class, ['categoryId' => 'id']);
    }
    ...
    public function getFamilyTreeArrayForWidget()
    {
        ...
        } elseif ($this->getMethods()->count() != 0) {
            foreach ($this->methods as $method) {
                $children[] = [
                    'id' => $method->id,
                    'name' => $method->htmlCodedTitle,
                    'code' => $method->uniqueCode,
    ...
    {
        return 'nad_investigation_method_category';
    }
