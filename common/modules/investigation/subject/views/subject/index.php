...
<div class="subject-index">
    <?php Panel::begin(['title' => $this->title]) ?>
        <?php Pjax::begin(['id' => 'subject-index-gridviewpjax']) ?>
            <?= GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'filter' => Subject::getStatusLables(),
                        'options' => [
                            'width' => '150px'
                        ]
                    ],
                    [
                        ...
                        'header' => 'دسترسی',
                        'template' => '{view} {certificate} {set-experts} {send-for-otherreport}',
                        'options' => [
                            'width' => '50px'
                        ],
                        'buttons' => [
