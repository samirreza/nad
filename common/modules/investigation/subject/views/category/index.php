...
<h2 class="nad-page-title">رده بندی موضوعها</h2>
    ...
    <?= ActionButtons::widget([
        'buttons' => [
            'create' => [
                ...
                'options' => [
                    'class' => 'ajaxcreate',
                    'data-gridpjaxid' => 'subject-category-gridviewpjax',
    ...
    <div class="row">
        <div class="col-md-12">
            <?php Panel::begin(['title' => 'لیست رده‌ها']) ?>
                <?php Pjax::begin([
                    'id' => 'subject-category-gridviewpjax',
                                ...
                                'buttons' => [
                                    'tree' => function ($url, $model, $key) use($module) {
                                        return Html::a(
                                            ...
                                            [
                                                // 'target' => '_blank',
                                                'title' => 'نمایش درختی رده های موضوع',
                                                'data-pjax' => 0
                                            ]
                                        );
                                    },
