...
namespace nad\temporary\supply\unit3\investigation5\proposal\controllers;

use yii\helpers\ArrayHelper;
use yii\filters\AccessControl;
use nad\temporary\supply\unit3\investigation5\proposal\models\Proposal;
use nad\temporary\supply\unit3\investigation5\proposal\models\ProposalArchived;
use nad\temporary\supply\unit3\investigation5\proposal\models\ProposalSearch;
use nad\temporary\supply\unit3\investigation5\proposal\models\ProposalArchivedSearch;
