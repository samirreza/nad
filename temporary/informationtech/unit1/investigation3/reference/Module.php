...
namespace nad\temporary\informationtech\unit1\investigation3\reference;

use nad\temporary\informationtech\unit1\investigation3\Module as BaseModule;
        ...
        $this->horizontalMenuItems = [
            [
                ...
                'items' => [
                    ...
                    [
                        'label' => 'پروپوزال',
                        'url' => ['/temporary/informationtech/unit1/investigation3/proposal/manage/index']
                    ],
                    [
                        'label' => 'گزارش',
                    ...
                    [
                        'label' => 'دستورالعمل',
                        'url' => ['/temporary/informationtech/unit1/investigation3/instruction/manage/index']
                    ],
                ]
            ],
            [
                ...
                'items' => [
                    ...
                    [
                        'label' => 'پروپوزال',
                        'url' => ['/temporary/informationtech/unit1/investigation3/proposal/manage/archived-index']
                    ],
                    [
                        'label' => 'گزارش',
                    ...
                    [
                        'label' => 'دستورالعمل',
                        'url' => ['/temporary/informationtech/unit1/investigation3/instruction/manage/archived-index']
                    ]
                ]
            ],
            [
                ...
                'items' => [
                    ...
                    [
                        'label' => 'پروپوزال',
                        'url' => ['/temporary/informationtech/unit1/investigation3/proposal/manage/index-history']
                    ],
                    [
                        'label' => 'گزارش',
                    ...
                    [
                        'label' => 'دستورالعمل',
                        'url' => ['/temporary/informationtech/unit1/investigation3/instruction/manage/index-history']
                    ]
                ]
            ],
            [
                ...
                'items' => [
                    ...
                    [
                        'label' => 'افزودن منبع',
                        'url' => ['/temporary/informationtech/unit1/investigation3/reference/manage/index#class_ajaxcreate']
                    ]
                ]
            ]
        ];
