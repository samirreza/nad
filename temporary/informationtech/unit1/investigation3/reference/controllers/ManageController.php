...
namespace nad\temporary\informationtech\unit1\investigation3\reference\controllers;

use yii\helpers\ArrayHelper;
use yii\filters\AccessControl;
use nad\temporary\informationtech\unit1\investigation3\reference\models\Reference;
use nad\temporary\informationtech\unit1\investigation3\reference\models\ReferenceSearch;
