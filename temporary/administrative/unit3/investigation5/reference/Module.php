...
namespace nad\temporary\administrative\unit3\investigation5\reference;

use nad\temporary\administrative\unit3\investigation5\Module as BaseModule;
        ...
        $this->horizontalMenuItems = [
            [
                ...
                'items' => [
                    ...
                    [
                        'label' => 'پروپوزال',
                        'url' => ['/temporary/administrative/unit3/investigation5/proposal/manage/index']
                    ],
                    [
                        'label' => 'گزارش',
            ...
            [
                ...
                'items' => [
                    ...
                    [
                        'label' => 'پروپوزال',
                        'url' => ['/temporary/administrative/unit3/investigation5/proposal/manage/archived-index']
                    ],
                    [
                        'label' => 'گزارش',
            ...
            [
                ...
                'items' => [
                    ...
                    [
                        'label' => 'پروپوزال',
                        'url' => ['/temporary/administrative/unit3/investigation5/proposal/manage/index-history']
                    ],
                    [
                        'label' => 'گزارش',
            ...
            [
                ...
                'items' => [
                    ...
                    [
                        'label' => 'افزودن منبع',
                        'url' => ['/temporary/administrative/unit3/investigation5/reference/manage/index#class_ajaxcreate']
                    ]
                ]
            ]
        ];
