...
use modules\nad\repairer\backend\modules\phonebook\models\Job;
...
$this->params['breadcrumbs'][] = [
    'label' => $repairer->title,
    'url' => ['/repairer/manage/view', 'id' => $repairer->id]
];
...
<div class="phonebook-manage-list">
    ...
    <?= ActionButtons::widget([
        'buttons' => [
            ...
            'repairerInfo' => [
                'label' => 'اطلاعات تعمیرکار',
                'url' => ['/repairer/manage/view', 'id' => $repairerId],
                'icon' => 'info',
                'type' => 'primary',
            ],
        ]
