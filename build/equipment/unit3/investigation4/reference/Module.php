...
namespace nad\build\equipment\unit3\investigation4\reference;

use nad\build\equipment\unit3\investigation4\Module as BaseModule;
        ...
        $this->horizontalMenuItems = [
            [
                ...
                'items' => [
                    ...
                    [
                        'label' => 'پروپوزال',
                        'url' => ['/build/equipment/unit3/investigation4/proposal/manage/index']
                    ],
                    [
                        'label' => 'گزارش',
            ...
            [
                ...
                'items' => [
                    ...
                    [
                        'label' => 'پروپوزال',
                        'url' => ['/build/equipment/unit3/investigation4/proposal/manage/archived-index']
                    ],
                    [
                        'label' => 'گزارش',
            ...
            [
                ...
                'items' => [
                    ...
                    [
                        'label' => 'پروپوزال',
                        'url' => ['/build/equipment/unit3/investigation4/proposal/manage/index-history']
                    ],
                    [
                        'label' => 'گزارش',
            ...
            [
                ...
                'items' => [
                    ...
                    [
                        'label' => 'افزودن منبع',
                        'url' => ['/build/equipment/unit3/investigation4/reference/manage/index#class_ajaxcreate']
                    ]
                ]
            ]
        ];
