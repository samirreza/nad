...
<div class="row">
    ...
    <?= InfoBox::widget([
            ...
            'showCount' => false,
            'title' => 'بررسی بهبود',
            'titleUrl' => Url::to(['/engineering/electricity/stage/manage/investigation-improvement'])
        ]) ?>
    </div>
    <div class="col-md-5" style="text-align: center">
    <?= InfoBox::widget([
            ...
            'titleUrl' => '#' // Url::to(['/engineering/electricity/stage/manage/investigation-monitor-methods'])
        ]) ?>
    </div>
</div>
<br><br>
    ...
    <div class="row">
        ...
        <div class="col-md-5">
            <?= InfoBox::widget([
                ...
                'showCount' => false,
                'title' => 'مراحل',
                'titleUrl' => Url::to(['/engineering/electricity/stage/category/index'])
            ]) ?>
        </div>
        <div class="col-md-5">
            <?= InfoBox::widget([
                ...
                'showCount' => false,
                'title' => 'مکان ها',
                'titleUrl' => '#' // Url::to(['/engineering/electricity/site/site/index'])
            ]) ?>
        </div>
    </div>
    <br><br>
