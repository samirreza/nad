...
namespace nad\engineering\electricity\stage\investigationDesign;
...
class Module extends \yii\base\Module
{
    ...
    {
        $this->modules = [
            'source' => 'nad\engineering\electricity\stage\investigationDesign\source\Module',
            'proposal' => 'nad\engineering\electricity\stage\investigationDesign\proposal\Module',
            'report' => 'nad\engineering\electricity\stage\investigationDesign\report\Module',
            'reference' => 'nad\engineering\electricity\stage\investigationDesign\reference\Module',
            // 'method' => 'nad\engineering\electricity\stage\investigationDesign\method\Module',
            // 'instruction' => 'nad\engineering\electricity\stage\investigationDesign\instruction\Module',
        ];
        $this->horizontalMenuItems = [
                ...
                'items' => [
                    [
                        ...
                        'items' => [
                            [
                                'label' => 'افزودن منشا',
                                'url' => ['/engineering/electricity/stage/investigationDesign/source/manage/create']
                            ],
                            [
                            ...
                            [
                                ...
                                'url' => ['/engineering/electricity/stage/investigationDesign/source/category/index']
                            ],
                        ]
                    ],
                    [
                    ...
                    [
                        ...
                        'items' => [
                            [
                                ...
                                'url' => ['/engineering/electricity/stage/investigationDesign/proposal/manage/create']
                            ],
                            [
                            ...
                            [
                                ...
                                'url' => ['/engineering/electricity/stage/investigationDesign/proposal/category/index']
                            ],
                        ]
                    ],
                    [
                ...
                'items' => [
                    [
                        ...
                        'items' => [
                            [
                                'label' => 'افزودن گزارش',
                                'url' => ['/engineering/electricity/stage/investigationDesign/report/manage/create']
                            ],
                            [
                            ...
                            [
                                ...
                                'url' => ['/engineering/electricity/stage/investigationDesign/report/category/index']
                            ],
                            [
                                'label' => 'گراف گزارشات',
                                'url' => ['/engineering/electricity/stage/investigationDesign/report/manage/generate-graph']
                            ]
                        ]
                    ],
                    [
            ...
            //                 [
            //                     'label' => 'افزودن روش',
            //                     'url' => ['/engineering/electricity/stage/investigationDesign/method/manage/create']
            //                 ],
            //                 [
            ...
            //                     'url' => ['/engineering/electricity/stage/investigationDesign/method/category/index']
            //                 ],
            //             ]
            //         ],
            //         [
            ...
            //                     'url' => ['/engineering/electricity/stage/investigationDesign/instruction/manage/create']
            //                 ],
            //                 [
            ...
            //                     'url' => ['/engineering/electricity/stage/investigationDesign/instruction/category/index']
            //                 ],
            //             ]
            //         ],
            //         [
