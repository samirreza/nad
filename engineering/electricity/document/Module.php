<?php
namespace nad\engineering\electricity\document;
...
class Module extends \yii\base\Module
{
    ...
    public function init()
    {
        $this->horizontalMenuItems = [
            ...
            //             'url' => ['/engineering/electricity/document/manage/index']
            //         ],
            //         [
            //             'label' => 'افزودن گروه مدارگ',
            //             'url' => ['/engineering/electricity/document/manage/index#class_ajaxcreate']
            //         ]
            //     ]
            // ],
        ];
