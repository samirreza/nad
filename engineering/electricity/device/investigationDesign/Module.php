...
namespace nad\engineering\electricity\device\investigationDesign;
...
class Module extends \yii\base\Module
{
    ...
    {
        $this->modules = [
            'source' => 'nad\engineering\electricity\device\investigationDesign\source\Module',
            'proposal' => 'nad\engineering\electricity\device\investigationDesign\proposal\Module',
            'report' => 'nad\engineering\electricity\device\investigationDesign\report\Module',
            'reference' => 'nad\engineering\electricity\device\investigationDesign\reference\Module',
            // 'method' => 'nad\engineering\electricity\device\investigationDesign\method\Module',
            // 'instruction' => 'nad\engineering\electricity\device\investigationDesign\instruction\Module',
        ];
        $this->horizontalMenuItems = [
                ...
                'items' => [
                    [
                        ...
                        'items' => [
                            [
                                'label' => 'افزودن منشا',
                                'url' => ['/engineering/electricity/device/investigationDesign/source/manage/create']
                            ],
                            [
                            ...
                            [
                                ...
                                'url' => ['/engineering/electricity/device/investigationDesign/source/category/index']
                            ],
                        ]
                    ],
                    [
                    ...
                    [
                        ...
                        'items' => [
                            [
                                ...
                                'url' => ['/engineering/electricity/device/investigationDesign/proposal/manage/create']
                            ],
                            [
                            ...
                            [
                                ...
                                'url' => ['/engineering/electricity/device/investigationDesign/proposal/category/index']
                            ],
                        ]
                    ],
                    [
                ...
                'items' => [
                    [
                        ...
                        'items' => [
                            [
                                'label' => 'افزودن گزارش',
                                'url' => ['/engineering/electricity/device/investigationDesign/report/manage/create']
                            ],
                            [
                            ...
                            [
                                ...
                                'url' => ['/engineering/electricity/device/investigationDesign/report/category/index']
                            ],
                            [
                                'label' => 'گراف گزارشات',
                                'url' => ['/engineering/electricity/device/investigationDesign/report/manage/generate-graph']
                            ]
                        ]
                    ],
                    [
            ...
            //                 [
            //                     'label' => 'افزودن روش',
            //                     'url' => ['/engineering/electricity/device/investigationDesign/method/manage/create']
            //                 ],
            //                 [
            ...
            //                     'url' => ['/engineering/electricity/device/investigationDesign/method/category/index']
            //                 ],
            //             ]
            //         ],
            //         [
            ...
            //                     'url' => ['/engineering/electricity/device/investigationDesign/instruction/manage/create']
            //                 ],
            //                 [
            ...
            //                     'url' => ['/engineering/electricity/device/investigationDesign/instruction/category/index']
            //                 ],
            //             ]
            //         ],
            //         [
