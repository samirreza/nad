...
namespace nad\engineering\electricity\device\investigationImprovement\proposal\controllers;

use yii\helpers\ArrayHelper;
use yii\filters\AccessControl;
use nad\engineering\electricity\device\investigationImprovement\proposal\models\Proposal;
use nad\engineering\electricity\device\investigationImprovement\proposal\models\ProposalArchived;
use nad\engineering\electricity\device\investigationImprovement\proposal\models\ProposalSearch;
use nad\engineering\electricity\device\investigationImprovement\proposal\models\ProposalArchivedSearch;
