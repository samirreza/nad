...
namespace nad\engineering\control\site\controllers;

use yii\helpers\ArrayHelper;
use yii\filters\AccessControl;
use nad\engineering\control\site\models\Document;
use nad\engineering\control\site\models\DocumentSearch;
                ...
                'access' => [
                    ...
                    'rules' => [
                        [
                            ...
                            // 'roles' => ['nad.engineering.control.site']
                            'roles' => ['@']
                        ]
                    ]
                ]
