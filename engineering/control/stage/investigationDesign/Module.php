...
namespace nad\engineering\control\stage\investigationDesign;
...
class Module extends \yii\base\Module
{
    ...
    {
        $this->modules = [
            'source' => 'nad\engineering\control\stage\investigationDesign\source\Module',
            'proposal' => 'nad\engineering\control\stage\investigationDesign\proposal\Module',
            'report' => 'nad\engineering\control\stage\investigationDesign\report\Module',
            'reference' => 'nad\engineering\control\stage\investigationDesign\reference\Module',
            // 'method' => 'nad\engineering\control\stage\investigationDesign\method\Module',
            // 'instruction' => 'nad\engineering\control\stage\investigationDesign\instruction\Module',
        ];
        $this->horizontalMenuItems = [
                ...
                'items' => [
                    [
                        ...
                        'items' => [
                            [
                                'label' => 'افزودن منشا',
                                'url' => ['/engineering/control/stage/investigationDesign/source/manage/create']
                            ],
                            [
                            ...
                            [
                                ...
                                'url' => ['/engineering/control/stage/investigationDesign/source/category/index']
                            ],
                        ]
                    ],
                    [
                    ...
                    [
                        ...
                        'items' => [
                            [
                                ...
                                'url' => ['/engineering/control/stage/investigationDesign/proposal/manage/create']
                            ],
                            [
                            ...
                            [
                                ...
                                'url' => ['/engineering/control/stage/investigationDesign/proposal/category/index']
                            ],
                        ]
                    ],
                    [
                ...
                'items' => [
                    [
                        ...
                        'items' => [
                            [
                                'label' => 'افزودن گزارش',
                                'url' => ['/engineering/control/stage/investigationDesign/report/manage/create']
                            ],
                            [
                            ...
                            [
                                ...
                                'url' => ['/engineering/control/stage/investigationDesign/report/category/index']
                            ],
                            [
                                'label' => 'گراف گزارشات',
                                'url' => ['/engineering/control/stage/investigationDesign/report/manage/generate-graph']
                            ]
                        ]
                    ],
                    [
            ...
            //                 [
            //                     'label' => 'افزودن روش',
            //                     'url' => ['/engineering/control/stage/investigationDesign/method/manage/create']
            //                 ],
            //                 [
            ...
            //                     'url' => ['/engineering/control/stage/investigationDesign/method/category/index']
            //                 ],
            //             ]
            //         ],
            //         [
            ...
            //                     'url' => ['/engineering/control/stage/investigationDesign/instruction/manage/create']
            //                 ],
            //                 [
            ...
            //                     'url' => ['/engineering/control/stage/investigationDesign/instruction/category/index']
            //                 ],
            //             ]
            //         ],
            //         [
