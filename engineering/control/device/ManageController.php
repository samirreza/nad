...
class ManageController extends \yii\web\Controller
{
    ...
    {
        return $this->render('@nad/engineering/control/device/index');
    }

    public function actionInvestigationImprovement()
    {
        return $this->render('@nad/engineering/control/device/investigationImprovement');
    }

    public function actionInvestigationMonitorMethods()
    {
        return $this->render('@nad/engineering/control/device/investigationMonitorMethods');
    }

    public function actionInvestigationDesign()
    {
        return $this->render('@nad/engineering/control/device/investigationDesign');
    }
}
