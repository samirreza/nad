...
namespace nad\engineering\piping\stage\investigationDesign;
...
class Module extends \yii\base\Module
{
    ...
    {
        $this->modules = [
            'source' => 'nad\engineering\piping\stage\investigationDesign\source\Module',
            'proposal' => 'nad\engineering\piping\stage\investigationDesign\proposal\Module',
            'report' => 'nad\engineering\piping\stage\investigationDesign\report\Module',
            'reference' => 'nad\engineering\piping\stage\investigationDesign\reference\Module',
            // 'method' => 'nad\engineering\piping\stage\investigationDesign\method\Module',
            // 'instruction' => 'nad\engineering\piping\stage\investigationDesign\instruction\Module',
        ];
        $this->horizontalMenuItems = [
                ...
                'items' => [
                    [
                        ...
                        'items' => [
                            [
                                'label' => 'افزودن منشا',
                                'url' => ['/engineering/piping/stage/investigationDesign/source/manage/create']
                            ],
                            [
                            ...
                            [
                                ...
                                'url' => ['/engineering/piping/stage/investigationDesign/source/category/index']
                            ],
                        ]
                    ],
                    [
                    ...
                    [
                        ...
                        'items' => [
                            [
                                ...
                                'url' => ['/engineering/piping/stage/investigationDesign/proposal/manage/create']
                            ],
                            [
                            ...
                            [
                                ...
                                'url' => ['/engineering/piping/stage/investigationDesign/proposal/category/index']
                            ],
                        ]
                    ],
                    [
                ...
                'items' => [
                    [
                        ...
                        'items' => [
                            [
                                'label' => 'افزودن گزارش',
                                'url' => ['/engineering/piping/stage/investigationDesign/report/manage/create']
                            ],
                            [
                            ...
                            [
                                ...
                                'url' => ['/engineering/piping/stage/investigationDesign/report/category/index']
                            ],
                            [
                                'label' => 'گراف گزارشات',
                                'url' => ['/engineering/piping/stage/investigationDesign/report/manage/generate-graph']
                            ]
                        ]
                    ],
                    [
            ...
            //                 [
            //                     'label' => 'افزودن روش',
            //                     'url' => ['/engineering/piping/stage/investigationDesign/method/manage/create']
            //                 ],
            //                 [
            ...
            //                     'url' => ['/engineering/piping/stage/investigationDesign/method/category/index']
            //                 ],
            //             ]
            //         ],
            //         [
            ...
            //                     'url' => ['/engineering/piping/stage/investigationDesign/instruction/manage/create']
            //                 ],
            //                 [
            ...
            //                     'url' => ['/engineering/piping/stage/investigationDesign/instruction/category/index']
            //                 ],
            //             ]
            //         ],
            //         [
