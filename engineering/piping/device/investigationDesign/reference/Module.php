...
namespace nad\engineering\piping\device\investigationDesign\reference;

use nad\engineering\piping\device\investigationDesign\Module as BaseModule;
        ...
        $this->horizontalMenuItems = [
            [
                ...
                'items' => [
                    ...
                    [
                        'label' => 'پروپوزال',
                        'url' => ['/engineering/piping/device/investigationDesign/proposal/manage/index']
                    ],
                    [
                        'label' => 'گزارش',
            ...
            [
                ...
                'items' => [
                    ...
                    [
                        'label' => 'پروپوزال',
                        'url' => ['/engineering/piping/device/investigationDesign/proposal/manage/archived-index']
                    ],
                    [
                        'label' => 'گزارش',
            ...
            [
                ...
                'items' => [
                    ...
                    [
                        'label' => 'پروپوزال',
                        'url' => ['/engineering/piping/device/investigationDesign/proposal/manage/index-history']
                    ],
                    [
                        'label' => 'گزارش',
            ...
            [
                ...
                'items' => [
                    ...
                    [
                        'label' => 'افزودن منبع',
                        'url' => ['/engineering/piping/device/investigationDesign/reference/manage/index#class_ajaxcreate']
                    ]
                ]
            ]
        ];
