...
use nad\engineering\mechanics\device\device\models\DevicePartInstanceDocument;
use nad\engineering\mechanics\device\device\models\DevicePartInstanceDocumentSearch;
