...
namespace nad\engineering\mechanics\device\investigationImprovement;
...
class Module extends \yii\base\Module
{
    ...
    {
        $this->modules = [
            'source' => 'nad\engineering\mechanics\device\investigationImprovement\source\Module',
            'proposal' => 'nad\engineering\mechanics\device\investigationImprovement\proposal\Module',
            'report' => 'nad\engineering\mechanics\device\investigationImprovement\report\Module',
            'reference' => 'nad\engineering\mechanics\device\investigationImprovement\reference\Module',
            'method' => 'nad\engineering\mechanics\device\investigationImprovement\method\Module',
            'instruction' => 'nad\engineering\mechanics\device\investigationImprovement\instruction\Module',
            'subject' => 'nad\engineering\mechanics\device\investigationImprovement\subject\Module',
        ];
                ...
                'items' => [
                    [
                        ...
                        'items' => [
                            [
                                'label' => 'افزودن منشا',
                                'url' => ['/engineering/mechanics/device/investigationImprovement/source/manage/create']
                            ],
                            [
                            ...
                            [
                                ...
                                'url' => ['/engineering/mechanics/device/investigationImprovement/source/category/index']
                            ],
                        ]
                    ],
                    [
                    ...
                    [
                        ...
                        'items' => [
                            [
                                ...
                                'url' => ['/engineering/mechanics/device/investigationImprovement/proposal/manage/create']
                            ],
                            [
                            ...
                            [
                                ...
                                'url' => ['/engineering/mechanics/device/investigationImprovement/proposal/category/index']
                            ],
                        ]
                    ],
                    [
                ...
                'items' => [
                    [
                        ...
                        'items' => [
                            [
                                'label' => 'افزودن گزارش',
                                'url' => ['/engineering/mechanics/device/investigationImprovement/report/manage/create']
                            ],
                            [
                            ...
                            [
                                ...
                                'url' => ['/engineering/mechanics/device/investigationImprovement/report/category/index']
                            ],
                            [
                                'label' => 'گراف گزارشات',
                                'url' => ['/engineering/mechanics/device/investigationImprovement/report/manage/generate-graph']
                            ]
                        ]
                    ],
                    [
                ...
                'items' => [
                    [
                        ...
                        'items' => [
                            [
                                'label' => 'افزودن روش',
                                'url' => ['/engineering/mechanics/device/investigationImprovement/method/manage/create']
                            ],
                            [
                            ...
                            [
                                ...
                                'url' => ['/engineering/mechanics/device/investigationImprovement/method/category/index']
                            ],
                        ]
                    ],
                    [
                    ...
                    [
                        ...
                        'items' => [
                            [
                                ...
                                'url' => ['/engineering/mechanics/device/investigationImprovement/instruction/manage/create']
                            ],
                            [
                            ...
                            [
                                ...
                                'url' => ['/engineering/mechanics/device/investigationImprovement/instruction/category/index']
                            ],
                        ]
                    ],
                    [
                ...
                'items' => [
                    [
                        ...
                        'items' => [
                            [
                                'label' => 'افزودن موضوع',
                                'url' => ['/engineering/mechanics/device/investigationImprovement/subject/manage/create']
                            ],
                            [
