<?php
namespace nad\engineering\mechanics\location;
...
class Module extends \yii\base\Module
{
    ...
    public function init()
    {
        $this->horizontalMenuItems = [
            ...
            //             'url' => ['/engineering/mechanics/location/manage/index']
            //         ],
            //         [
            //             'label' => 'افزودن گروه مدارگ',
            //             'url' => ['/engineering/mechanics/location/manage/index#class_ajaxcreate']
            //         ]
            //     ]
            // ],
        ];
