<?php
namespace nad\engineering\construction\document;
...
class Module extends \yii\base\Module
{
    ...
    public function init()
    {
        $this->horizontalMenuItems = [
            ...
            //             'url' => ['/engineering/construction/document/manage/index']
            //         ],
            //         [
            //             'label' => 'افزودن گروه مدارگ',
            //             'url' => ['/engineering/construction/document/manage/index#class_ajaxcreate']
            //         ]
            //     ]
            // ],
        ];
