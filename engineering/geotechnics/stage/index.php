...
<div class="row">
    ...
    <?= InfoBox::widget([
            ...
            'showCount' => false,
            'title' => 'بررسی بهبود',
            'titleUrl' => Url::to(['/engineering/geotechnics/stage/manage/investigation-improvement'])
        ]) ?>
    </div>
    <div class="col-md-5" style="text-align: center">
    <?= InfoBox::widget([
            ...
            'titleUrl' => '#' // Url::to(['/engineering/geotechnics/stage/manage/investigation-monitor-methods'])
        ]) ?>
    </div>
</div>
<br><br>
<div class="row">
    ...
    <?= InfoBox::widget([
            ...
            'showCount' => false,
            'title' => 'بررسی طراحی',
            'titleUrl' => '#' // Url::to(['/engineering/geotechnics/stage/manage/investigation-design'])
        ]) ?>
    </div>
</div>
<br><br>
    ...
    <div class="row">
        ...
        <div class="col-md-5">
            <?= InfoBox::widget([
                ...
                'showCount' => false,
                'title' => 'مراحل',
                'titleUrl' => Url::to(['/engineering/geotechnics/stage/category/index'])
            ]) ?>
        </div>
        <div class="col-md-5">
            <?= InfoBox::widget([
