...
namespace nad\engineering\geotechnics\device\investigationMonitorMethods\reference\controllers;

use yii\helpers\ArrayHelper;
use yii\filters\AccessControl;
use nad\engineering\geotechnics\device\investigationMonitorMethods\reference\models\Reference;
use nad\engineering\geotechnics\device\investigationMonitorMethods\reference\models\ReferenceSearch;
