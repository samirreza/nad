...
namespace nad\engineering\instrument\stage\investigationDesign;
...
class Module extends \yii\base\Module
{
    ...
    {
        $this->modules = [
            'source' => 'nad\engineering\instrument\stage\investigationDesign\source\Module',
            'proposal' => 'nad\engineering\instrument\stage\investigationDesign\proposal\Module',
            'report' => 'nad\engineering\instrument\stage\investigationDesign\report\Module',
            'reference' => 'nad\engineering\instrument\stage\investigationDesign\reference\Module',
            // 'method' => 'nad\engineering\instrument\stage\investigationDesign\method\Module',
            // 'instruction' => 'nad\engineering\instrument\stage\investigationDesign\instruction\Module',
        ];
        $this->horizontalMenuItems = [
                ...
                'items' => [
                    [
                        ...
                        'items' => [
                            [
                                'label' => 'افزودن منشا',
                                'url' => ['/engineering/instrument/stage/investigationDesign/source/manage/create']
                            ],
                            [
                            ...
                            [
                                ...
                                'url' => ['/engineering/instrument/stage/investigationDesign/source/category/index']
                            ],
                        ]
                    ],
                    [
                    ...
                    [
                        ...
                        'items' => [
                            [
                                ...
                                'url' => ['/engineering/instrument/stage/investigationDesign/proposal/manage/create']
                            ],
                            [
                            ...
                            [
                                ...
                                'url' => ['/engineering/instrument/stage/investigationDesign/proposal/category/index']
                            ],
                        ]
                    ],
                    [
                ...
                'items' => [
                    [
                        ...
                        'items' => [
                            [
                                'label' => 'افزودن گزارش',
                                'url' => ['/engineering/instrument/stage/investigationDesign/report/manage/create']
                            ],
                            [
                            ...
                            [
                                ...
                                'url' => ['/engineering/instrument/stage/investigationDesign/report/category/index']
                            ],
                            [
                                'label' => 'گراف گزارشات',
                                'url' => ['/engineering/instrument/stage/investigationDesign/report/manage/generate-graph']
                            ]
                        ]
                    ],
                    [
            ...
            //                 [
            //                     'label' => 'افزودن روش',
            //                     'url' => ['/engineering/instrument/stage/investigationDesign/method/manage/create']
            //                 ],
            //                 [
            ...
            //                     'url' => ['/engineering/instrument/stage/investigationDesign/method/category/index']
            //                 ],
            //             ]
            //         ],
            //         [
            ...
            //                     'url' => ['/engineering/instrument/stage/investigationDesign/instruction/manage/create']
            //                 ],
            //                 [
            ...
            //                     'url' => ['/engineering/instrument/stage/investigationDesign/instruction/category/index']
            //                 ],
            //             ]
            //         ],
            //         [
