<?php
namespace nad\engineering\instrument\location;
...
class Module extends \yii\base\Module
{
    ...
    public function init()
    {
        $this->horizontalMenuItems = [
            ...
            //             'url' => ['/engineering/instrument/location/manage/index']
            //         ],
            //         [
            //             'label' => 'افزودن گروه مدارگ',
            //             'url' => ['/engineering/instrument/location/manage/index#class_ajaxcreate']
            //         ]
            //     ]
            // ],
        ];
