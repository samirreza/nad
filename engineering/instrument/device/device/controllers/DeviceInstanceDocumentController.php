...
use nad\engineering\instrument\device\device\models\DeviceInstanceDocument;
use nad\engineering\instrument\device\device\models\DeviceInstanceDocumentSearch;
